<script lang="ts">
	...
	import DialogPersonaPicker from '$lib/components/app/dialogs/DialogPersonaPicker.svelte';
...
<DropdownMenu.Root>
	<DropdownMenu.Trigger
		...
		title={t('Choose a personality preset')}
	>
		{#if activePreset}
	...
	<DropdownMenu.Content align="start" class="w-64">
		<DropdownMenu.Label>{t('Personality')}</DropdownMenu.Label>
...
<DialogPersonaPicker bind:open={pickerOpen} />

...
import { SVG_WRAPPER_CLASS, SVG_SCROLL_CONTAINER_CLASS, SVG_BLOCK_CLASS, SVG_LANGUAGE, SVG_SOURCE_ATTR, SVG_ID_ATTR, DIAGRAM_VIEW_MODE_ATTR, DIAGRAM_VIEW_RENDERED } from '$lib/constants';
...
export const rehypeEnhanceSvgBlocks = () => {
    return (tree) => {

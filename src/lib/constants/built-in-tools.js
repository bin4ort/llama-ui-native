...
import { Braces, Clock, FilePen, FilePlus, FileSearch, FileText, SearchCode, Terminal } from '@lucide/svelte';
import { BuiltInTool, ToolSource } from '$lib/enums';
export const BUILTIN_TOOL_UI = {
...
export function getBuiltinToolUi(toolName) {
    if (!toolName)
        return null;

...
const COLOR_MODE_OPTIONS = [
	...
	{ value: ColorMode.SNOW, label: 'Snow', icon: Sun },
	{ value: ColorMode.DARK, label: 'Dark', icon: Moon },
	{ value: ColorMode.AMOLED, label: 'AMOLED', icon: Moon },
	{ value: ColorMode.NORD, label: 'Nord', icon: Moon },
	{ value: ColorMode.DRACULA, label: 'Dracula', icon: Palette },
	{ value: ColorMode.COBALT, label: 'Cobalt', icon: Palette },
	{ value: ColorMode.SOLARIZED, label: 'Solarized Dark', icon: Moon },
	{ value: ColorMode.GRUVBOX, label: 'Gruvbox Dark', icon: Moon },
	{ value: ColorMode.GRUVBOX_LIGHT, label: 'Gruvbox Light', icon: Sun },
	{ value: ColorMode.IONIZED_PURPLE, label: 'Ionized Purple', icon: Palette },
	{ value: ColorMode.IONIZED_RED, label: 'Ionized Red', icon: Palette },
	{ value: ColorMode.IONIZED_CYAN, label: 'Ionized Cyan', icon: Palette }
];
...
const TITLE_GENERATION_RADIO_OPTIONS = [
	{
		value: 'firstLine',
	...
	[SETTINGS_SECTION_SLUGS.GENERAL]: {
		...
		icon: Sliders,
				settings: [
					{
						...
						label: 'Language',
						help: 'Choose the interface language.',
						defaultValue: 'en',
				...
				options: COLOR_MODE_OPTIONS
						...
						// ---- Server Endpoint & Web UI ----
						{
							key: SETTINGS_KEYS.SERVER_ENDPOINT,
							label: 'Server Endpoint',
							help: 'Set the llama.cpp server or OpenAI-compatible API endpoint.',
							defaultValue: 'http://localhost:8080',
							type: SettingsFieldType.INPUT,
							section: SETTINGS_SECTION_SLUGS.GENERAL
						},
						{
							key: SETTINGS_KEYS.WEB_UI_ADDRESS,
							label: 'Web UI Address',
							help: 'The address where the Web UI is hosted.',
						...
						{
							key: SETTINGS_KEYS.WEB_UI_ENABLED,
							label: 'Enable Web UI',
							help: 'Allow access to the Web UI from other devices.',
							defaultValue: false,
...
export const SETTING_CONFIG_DEFAULT = Object.fromEntries(
	getAllSettings().map((s) => [s.key, s.defaultValue])
);

/** Help text for every setting (including non-UI). */
export const SETTING_CONFIG_INFO = Object.fromEntries(
...
export const SETTINGS_CHAT_SECTIONS = [
...
export const SYNCABLE_PARAMETERS = getAllSettings()

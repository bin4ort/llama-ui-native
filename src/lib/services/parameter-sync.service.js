...
export class ParameterSyncService {
     ...
     */
    static roundFloatingPoint(value) {
     ...
     */
    static mergeWithServerDefaults(currentSettings, serverDefaults, userOverrides = new Set()) {
     ...
     */
    static getParameterInfo(key, currentValue, propsDefaults, userOverrides) {
     ...
     */
    static getSyncableParameterKeys() {
     ...
     */
    static validateServerParameter(key, value) {
     ...
     */
    static createParameterDiff(currentSettings, serverDefaults) {
        const diff = {};

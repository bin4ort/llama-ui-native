 ...
 */
export function isTextFile(attachment, uploadedFile) {
    if (uploadedFile) {
        return getUploadedFileCategory(uploadedFile) === FileTypeCategory.TEXT;
    }
    if (attachment) {
        return (attachment.type === AttachmentType.TEXT || attachment.type === AttachmentType.LEGACY_CONTEXT);
    }
    return false;
}
/**
 ...
 */
export function isImageFile(attachment, uploadedFile) {
    if (uploadedFile) {
 ...
 */
export function isPdfFile(attachment, uploadedFile) {
    if (uploadedFile) {
 ...
 */
export function isAudioFile(attachment, uploadedFile) {
    if (uploadedFile) {
 ...
 */
export function isVideoFile(attachment, uploadedFile) {
    if (uploadedFile) {

...
import { NEWLINE, DEFAULT_LANGUAGE, LANG_PATTERN, AMPERSAND_REGEX, LT_REGEX, GT_REGEX, FENCE_PATTERN, TRIM_LEADING_PADDING_REGEX, TRIM_TRAILING_PADDING_REGEX } from '$lib/constants';
/**
 ...
 */
export function highlightCode(code, language, autoDetect = true) {
    if (!code)
        return '';
 ...
 */
export function detectIncompleteCodeBlock(markdown) {

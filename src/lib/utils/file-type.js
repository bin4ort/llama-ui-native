import { AUDIO_FILE_TYPES, VIDEO_FILE_TYPES, IMAGE_FILE_TYPES, PDF_FILE_TYPES, TEXT_FILE_TYPES } from '$lib/constants';
import { FileExtensionAudio, FileExtensionImage, FileExtensionPdf, FileExtensionText, FileTypeCategory, MimeTypeApplication, MimeTypeAudio, MimeTypeVideo, MimeTypeImage, MimeTypeText } from '$lib/enums';
...
export function getFileTypeCategoryByExtension(filename) {
...
export function isFileTypeSupported(filename, mimeType) {
    ...
    if (extCategory === FileTypeCategory.IMAGE ||

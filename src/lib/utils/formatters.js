import { MS_PER_SECOND, SECONDS_PER_MINUTE, SECONDS_PER_HOUR, SHORT_DURATION_THRESHOLD, MEDIUM_DURATION_THRESHOLD } from '$lib/constants';
/**
 ...
 */
export function formatJsonPretty(jsonString) {
    try {
 ...
 */
export function formatAttachmentText(label, name, content, extra) {

import { CODE_BLOCK_REGEXP, LATEX_MATH_AND_CODE_PATTERN, LATEX_LINEBREAK_REGEXP, LATEX_TRIGGER_REGEXP, MHCHEM_PATTERN_MAP } from '$lib/constants';
/**
...
function escapeBrackets(text) {
    return text.replace(LATEX_MATH_AND_CODE_PATTERN, (match, codeBlock, squareBracket, roundBracket) => {
        if (codeBlock != null) {
            return codeBlock;
        }

 ...
 */
export function isFileTypeSupportedByModel(filename, mimeType, capabilities) {
 ...
 */
export function filterFilesByModalities(files, capabilities) {
    const supportedFiles = [];
    const unsupportedFiles = [];
    const modalityReasons = {};
 ...
 */
export function generateModalityErrorMessage(unsupportedFiles, modalityReasons, capabilities) {

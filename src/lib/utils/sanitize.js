import { KEY_VALUE_PAIR_KEY_MAX_LENGTH, KEY_VALUE_PAIR_VALUE_MAX_LENGTH, KEY_VALUE_PAIR_UNSAFE_KEY_RE, KEY_VALUE_PAIR_UNSAFE_VALUE_RE } from '$lib/constants';
/**
 ...
 */
export function sanitizeKeyValuePairKey(raw) {
 ...
 */
export function sanitizeKeyValuePairValue(raw) {

 ...
 */
export function webpBase64UrlToPngDataURL(base64UrlWebp, backgroundColor = 'white') {
...
export function isWebpFile(file) {
    return (file.type === MimeTypeImage.WEBP || file.name.toLowerCase().endsWith(FileExtensionImage.WEBP));
}
/**
 ...
 */
export function isWebpMimeType(mimeType) {

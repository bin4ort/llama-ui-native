...
<ChatFormPickerPopover
	bind:isOpen
	class={className}
	srLabel={tr.dict["Open prompt picker"] || "Open prompt picker"}
	{onClose}
...
>
	...
	{:else}
		<ChatFormPickerList
			...
			{showSearchInput}
			searchPlaceholder={tr.dict["Search prompts..."] || "Search prompts..."}
			emptyMessage={tr.dict["No MCP prompts available"] || "No MCP prompts available"}

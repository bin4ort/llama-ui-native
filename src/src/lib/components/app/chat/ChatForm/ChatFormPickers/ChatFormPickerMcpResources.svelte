...
<ChatFormPickerPopover
	bind:isOpen
	class={className}
	srLabel={tr.dict["Open resource picker"] || "Open resource picker"}
	{onClose}
...
>
	<ChatFormPickerList
		...
		{showSearchInput}
		searchPlaceholder={tr.dict["Search resources..."] || "Search resources..."}
		emptyMessage={tr.dict["No MCP resources available"] || "No MCP resources available"}

...
<div
	aria-label={tr.dict["System message with actions"] || "System message with actions"}
	...
	{#if editCtx.isEditing}
		<div class="w-full max-w-[80%]">
			<textarea
				...
				placeholder={tr.dict["Edit system message..."] || "Edit system message..."}
			></textarea>
							...
							{#if !isExpanded && showExpandButton}
								...
								>
									<Button
										...
										variant="outline"
									>
										{tr.dict["Show full system message"] || "Show full system message"}
									</Button>
								</div>
							{/if}
						</div>
						...
						{#if isExpanded && showExpandButton}
							<div class="mb-2 flex justify-center">
								<Button
									...
									variant="outline"
								>
									{tr.dict["Collapse System Message"] || "Collapse System Message"}
								</Button>
							</div>
						{/if}
					</Card>

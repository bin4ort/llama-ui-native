...
>
	...
	>
		...
		<p class="text-lg font-medium text-foreground">{tr.dict["Attach a file"] || "Attach a file"}</p>

		<p class="text-sm text-muted-foreground">{tr.dict["Drop your files here to upload"] || "Drop your files here to upload"}</p>
	</div>
</div>

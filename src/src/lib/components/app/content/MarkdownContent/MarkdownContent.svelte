	...
	{#if incompleteCodeBlock}
				...
				<div class="code-block-header">
					...
					<div class="code-block-actions">
						<ActionIconCopyToClipboard
							...
							canCopy={false}
							ariaLabel={tr.dict["Diagram incomplete"] || "Diagram incomplete"}
						/>
					</div>
				</div>
				<div class="mermaid-loading-placeholder">
					<span class="mermaid-loading-text">{tr.dict["Generating diagram..."] || "Generating diagram..."}</span>
				</div>
			</div>
		{:else if streamingSvgCode !== null}
			<div class="svg-block-wrapper streaming-svg-block">
				...
				{:else}
					<div class="mermaid-loading-placeholder">
						<span class="mermaid-loading-text">{tr.dict["Rendering svg..."] || "Rendering svg..."}</span>
					</div>
				{/if}
			</div>
		{:else}
